...
%define ac_basever 2.6x
%define real_name autoconf
%define name autoconf26x
...
./configure --prefix=%{_prefix} \
    ...
    --bindir=%{_bindir} \
    --datadir=%{_datadir} \
    --with-lispdir=%{_datadir}/%{real_name}%{ac_basever}/emacs \
    --datarootdir=%{_datadir}/%{real_name}%{ac_basever} \
    --datadir=%{_datadir}/%{real_name}%{ac_basever} \
    --program-suffix=%{ac_basever}
...
# cleanup
mv %{buildroot}%{_infodir}/autoconf.info %{buildroot}%{_infodir}/autoconf26x.info
...
%post
/sbin/install-info %{_infodir}/autoconf26x.info %{_infodir}/dir || :

%preun
if [ "$1" = 0 ]; then
    /sbin/install-info --del %{_infodir}/autoconf26x.info %{_infodir}/dir || :
fi

%files
%defattr(-,root,root,-)
%{_bindir}/*
%{_infodir}/autoconf26x.info*
# don't include standards.info, because it comes from binutils...
%exclude %{_infodir}/standards*
%{_datadir}/autoconf%{ac_basever}
%{_mandir}/man1/*
%doc AUTHORS COPYING ChangeLog NEWS README THANKS TODO

%changelog
* Wed Oct 07 2012 Stephan Linz <linz@li-pro.net> - 2.63-5.ius
- Change execution permission for source 1 and 2 (important on OBS)

* Wed Feb 02 2011 BJ Dierkes <wdierkes@rackspace.com> - 2.63-4.ius
- No longer Provide: autoconf

* Wed Sep 09 2009 BJ Dierkes <wdierkes@rackspace.com> - 2.63-3.ius
- Rebuilding for IUS, renaming package autoconf26x
